...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SingleWifiReport.timestamp'
        db.add_column(u'analysis_singlewifireport', 'timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SingleWifiReport.timestamp'
        db.delete_column(u'analysis_singlewifireport', 'timestamp')
